...
<body>
	...
	<div class="place">
		...
		<ul class="placeul">
			...
			<li><a href="SchoolManagementServlet?pageTag=addMajor">添加专业</a></li>
		</ul>
	</div>
				...
				<form action="AddMajorServlet" method="post">
					<ul class="forminfo">
						<li><label>学校名称<b>*</b></label>
							<div class="vocation">
								<select name="school" id="school" class="select1" onchange="getDept()">
						...
						<li><label>院系名称<b>*</b></label>
							<div class="vocation">
								<select name="dept" id="dept" class="select1">
								    <option value="" selected="selected">请选择</option>
								</select>
							</div></li>

						<li><label>专业名称<b>*</b></label><input name="majorName"
							type="text" class="dfinput" placeholder="请输入专业名称"
